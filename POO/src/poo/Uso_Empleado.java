...
public class Uso_Empleado {
	...
	public static void main(String[] args) {
		...
		misEmpleados[2] = new Empleado("María Martin",105000,2002,03,15);
...
class Empleado{
	...
	private String sector = "Administración";
...
class Jefatura extends Empleado {
	...
	public double getSueldo() {
		double sueldoJefe = super.getSueldo(); //El super hace que llame al método del mismo nombre pero que está en la clase padre
